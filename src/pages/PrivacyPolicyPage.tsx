      ...
      <div className="container mx-auto px-4 md:px-6 max-w-3xl">
        ...
        <div className="space-y-10 text-dark-400 leading-relaxed">
          <section>
            ...
            <p>
              R Flow Productions ("we," "our," or "us") respects your privacy
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>IP address</strong> and approximate geographic location
              </li>
              <li>
                <strong>Cookies and tracking technologies:</strong> we use
                cookies, pixels (including the Meta Pixel), and similar
                technologies to analyze site traffic and improve your experience
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Our Site may contain links to third-party websites (e.g.,
              Calendly, YouTube, social media platforms). We are not responsible
          ...
          <section>
            ...
            <p>
              Our Site is not directed to individuals under the age of 16. We do
