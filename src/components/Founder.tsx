          ...
          <div className="grid md:grid-cols-5 gap-8 lg:gap-16 items-center">
            ...
            >
              <div className="relative">
                <div className="absolute inset-0 -translate-x-4 -translate-y-4 border-2 border-accent-500 rounded-xl z-0"></div>
            ...
            >
              ...
              <div className="text-white/80 space-y-4">
                ...
                <p>
                  <strong className="text-white">The problem I kept seeing</strong>: Incredible people doing incredible work, but struggling to communicate their value in a way that truly resonated.
                </p>
                
                <p>
                  <strong className="text-white">That's when I realized</strong>: The most powerful tool for establishing authority isn't just expertise—it's the ability to tell your story in a way that moves people to action.
                </p>
              ...
              <div className="mt-6 text-right">
                <p className="font-serif text-accent-500 italic text-lg">— Sir-Tay Jackson</p>
                <p className="text-white/70 text-sm">Founder & Chief Storyteller</p>
              </div>
            </motion.div>
          </div>
        </div>
