      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/70">
              <li><a href="#features" className="hover:text-accent-500 transition-colors">Why Choose Us</a></li>
              <li><a href="#process" className="hover:text-accent-500 transition-colors">Our Process</a></li>
              <li><a href="#case-study" className="hover:text-accent-500 transition-colors">Case Studies</a></li>
              <li><a href="#faq" className="hover:text-accent-500 transition-colors">FAQs</a></li>
            </ul>
          </div>
            ...
            <ul className="space-y-3 text-white/70">
              <li>
                <a 
                  ...
                  className="flex items-start hover:text-accent-500 transition-colors group"
                >
                  <Mail className="text-accent-500 mt-1 mr-2 flex-shrink-0 group-hover:scale-110 transition-transform" size={16} />
              ...
              <li>
                <a 
                  ...
                  className="flex items-start hover:text-accent-500 transition-colors group"
                >
                  <Phone className="text-accent-500 mt-1 mr-2 flex-shrink-0 group-hover:scale-110 transition-transform" size={16} />
                  <span>203-309-7484</span>
                </a>
              </li>
              <li className="flex items-start">
                <MapPin className="text-accent-500 mt-1 mr-2 flex-shrink-0" size={16} />
        ...
        <div className="border-t border-dark-700 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="#" className="text-white/70 hover:text-accent-500 transition-colors">Privacy Policy</a>
            <a href="#" className="text-white/70 hover:text-accent-500 transition-colors">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
