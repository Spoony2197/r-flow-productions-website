      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-8">
            <span className="text-brand-bright font-semibold">Your competitors are creating content.</span> You could be creating authority.
          </p>
          ...
          <div className="bg-dark-900/80 backdrop-blur-sm rounded-xl p-8 mb-10 shadow-strong">
            <h3 className="font-display text-xl text-white mb-6">What you get in your strategy session:</h3>

            <div className="grid md:grid-cols-2 gap-4 text-left max-w-2xl mx-auto">
              <div className="flex items-start">
                <CheckCircle className="text-brand-bright mt-1 mr-3 flex-shrink-0" size={20} />
                <p className="text-white/90">Analysis of your current market position</p>
              </div>
              <div className="flex items-start">
                <CheckCircle className="text-brand-bright mt-1 mr-3 flex-shrink-0" size={20} />
                <p className="text-white/90">Identification of your unique story elements</p>
              </div>
              <div className="flex items-start">
                <CheckCircle className="text-brand-bright mt-1 mr-3 flex-shrink-0" size={20} />
                <p className="text-white/90">Clear roadmap for authority-building content</p>
              </div>
              <div className="flex items-start">
                <CheckCircle className="text-brand-bright mt-1 mr-3 flex-shrink-0" size={20} />
                <p className="text-white/90">Understanding of our 4-step process for your specific situation</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 flex flex-col md:flex-row items-center justify-center space-y-2 md:space-y-0 md:space-x-6 text-sm text-white/70">
            <div className="flex items-center">
              <CheckCircle className="text-brand-bright mr-2" size={16} />
